...
export default function CheckoutPageCopy(){
    ...
    const handleCfAddress = (values, {setSubmitting, resetForm}) => {
        setSubmitting(true);
    ...
    const handleClickOrder = async () =>{
        ...
        if(billingAddress && !_.isEmpty(billingAddress)){
                ...
                <div className="checkout_page_container">
                    ...
                    <div className="checkout_page_content">
                        ...
                        <Formik
                            ...
                            onSubmit={(values, {setSubmitting, resetForm})=> handleCfAddress(values, {setSubmitting, resetForm})}
                            initialValues={{
                                firstName: firstName,
                                lastName: lastName,
                                address: address,
                            ...
                            {({
                                ...
                                <Form noValidate onSubmit={handleSubmit}>
                                    <div className="header-checkout-detail">
                                        ...
                                        <Button type="submit" disabled={isSubmitting}>Confirm address</Button>
                                    </div>
                                    {message && (
...
//     <Formik
//       validationSchema={schema}
//       onSubmit={(values, {setSubmitting, resetForm})=> handleSubmitForm(values, {setSubmitting, resetForm})}
//       initialValues={{
//         firstName: 'Mark',
//         lastName: 'Otto',
//         username: '',
